...
Generative artificial intelligence is capable of amazing feats, ranging from generating human-like speech and text to creating brand-new music and images. But we can’t take advantage of all its capabilities if we can’t provide it with detailed, easy to follow instructions. We’re, naturally, talking about prompts.

Prompt engineering is the practice of fine-tuning the commands used to control generative AI. Although we’ve already visited the topic before, now it’s time to get in deeper and really hone up those prompts on a detailed level. Shall we get started?
...
**Important**: No matter how good of a prompt you can design, responses from AI models should never be taken as fact or completely free from bias. Always use AI responsibly. We’ll visit this aspect later in this unit.
...
Before exploring how prompt engineering can improve the output of Azure OpenAI models, it's important to consider how the different endpoints can utilize the methods discussed in this section. While both Completion and ChatCompletion can both achieve similar results, ChatCompletion provides the most flexibility in building your prompts, and is optimized for chat scenarios.
...
The Completion endpoint can still achieve similar results, but more care must be taken to format the prompt clearly for the AI model to understand. Most of the examples given in this section clearly translate to ChatCompletion, however you can reformat it for use with Completion.
...
In addition to techniques discussed here, adjusting parameters of the model can have a significant impact on the response. In particular, temperature and top_p (top_probability) are the most likely to impact a model's response as they both control randomness in the model, but in different ways.
...
There are multiple ways of making your prompts more efficient and powerful. You should always keep in mind, however, that generative AI will never create the same response twice – even an identical prompt will lead to two different outputs when used twice in a row.
...
Let’s review some best practices of effective prompt engineering. We’ll start with a few foundational guidelines and make our way to context and accuracy.
...
Here’s a very similar prompt, but with clear instructions:
...
code
<edukamu-image url="/graphics/module4/2024-01-31-primary-supporting-and-grounding.svg" alt="" style="">
<br>
...
code
<edukamu-image url="/graphics/module4/2024-01-31-supporting-and-grounding.svg" alt="" style="">
<br>
...
code
<edukamu-image url="/graphics/module4/2024-01-31-grounding.svg" alt="" style="">
<br>
...
Cues are leading words for the model to build upon, and often help shape the response in the right direction. They often are used with instructions, but don't always. Cues are particularly helpful if prompting the model for code generation.
...
In addition to the best practices described above, providing context through prompt engineering is just as vital in influencing the results obtained from generative AI models.

Context helps the model understand user intent and produce more relevant and accurate responses – by framing prompts effectively, users can guide the model to generate content that aligns with their specific needs or tasks.

Providing context to the AI model allows the model to better understand what you are asking for or what it should know to provide the best answer. Context can be provided in several ways.

(In the following examples, the C# programming language will be used.)
</edukamu-section>
<br>
...
The choice of words and context provided can significantly impact the tone, relevance, and quality of the AI-generated output, making prompt engineering a crucial aspect of achieving desired outcomes in AI-driven applications.

You should practice prompting regularly, as generative AI is here to stay. You can use OpenAI’s ChatGPT service or Microsoft’s Copilot in order to get started – it’s very simple and straightforward!

<edukamu-button url="https://copilot.microsoft.com/" target="_blank">Microsoft Copilot</edukamu-button>
<br>

(Please notice that you need to sign into your Microsoft account in order to use the Microsoft Copilot. You can use your personal account as well.)

<!-- <edukamu-collapse isCollapsed="true" title-level="4">
<edukamu-collapse-hidden-title collapseType="tehtava">
### Practice: Utilizing Prompt Engineering
</edukamu-collapse-hidden-title>
...
In this practice exercise, we’ll work with prompt engineering to improve the generative AI model’s accuracy within an application. We’ll again need to fire up a lab environment in order to complete the practice exercise.
...
<edukamu-button url="https://learn.microsoft.com/en-us/training/modules/apply-prompt-engineering-azure-openai/5-exercise?launch-lab=true" target="_blank">Microsoft Learn: Lab Environment</edukamu-button>
<br>
...
Now it’s time to consolidate your knowledge with a traditional exercise – take some time to recap before tackling it!
...
<edukamu-question-scroll url="/exercises/module4/fine-tuning-effective-prompts-question-scroll-1.yaml" id="zz5mnieacq6z0wj9">
<br>
...
Writing effective prompts can be the difference between a not-so-useful and an amazing generative AI model – and the defining factor might well be the person using the model! By fine-tuning your prompts up to the detail, you can make sure that you get everything out of this amazing technology.

Prompt engineering is also crucial when it comes to writing code with generative AI. It is also our next topic!
